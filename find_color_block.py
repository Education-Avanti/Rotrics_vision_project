...
MAX_SLIDER_MOVE=[None, None, None, 950]
...
class Find_color_block(QtWidgets.QWidget, Ui_find_color_block):
    ...
    def __init__(self):
        ...
        self.Box_x.setRange(0,1000)
        self.Box_y.setRange(0,1000)
    ...
    def get_ARM_pos(self,x,y):
        ...
        y = VIEW_CENTER[1] - math.ceil(float((y-320)*1000) / float(obj_y) / float(1000))
...
class Gcode(object):
    ...
    def stop_check_3d(self):
        return "M302P1\r\n"
    
    def begin_check_3d(self):
        return "M302P0\r\n"
    ...
    def XYZE(self,x,y,z,e):
        temp = "G0"+"X"+str(x)+"Y"+str(y)+"Z"+str(z)+"E"+str(e)+"F5000"+"\r\n"
        return temp
